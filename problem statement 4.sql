...
-- 5
select p1.personname,p1.gender,p2.dob,
case when p2.dob>='2005-01-01' and p1.gender='male' then 'Youngmale'
when p2.dob>='2005-01-01'and p1.gender ='female' then 'youngfemale'
when p2.dob>'1985-01-01' and p2.dob<'2005-01-01'and p1.gender='male' then 'Adultmale'
when p2.dob>'1985-01-01' and p2.dob<'2005-01-01'and p1.gender='female' then 'Adultfemale'
