...
begin
declare d_name varchar(15);
select d.diseaseName into d_name from address ad
...
where ad.state=stateName and year(date)=d_year limit 1;
return d_name;
end $$
delimiter ;
...
delimiter ;
select average_balance_of_claims('Go Digit General Insurance Co.Ltd','2021');
